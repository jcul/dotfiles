...
terminal = os.getenv("HOME") .. "/bin/st"
...
wttr = awful.widget.watch('curl wttr.in/Cork?format="%C,+%t"', 1200)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "i", nil, function() awful.util.spawn("clipimg") end),
   -- Volume Keys
